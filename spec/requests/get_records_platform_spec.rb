...
<csw:GetRecords xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" resultType="results"
    ...
    <csw:Query typeNames="csw:Record">
      ...
      eos
      post '/', platform_constraint_get_records_request_xml
...
<csw:GetRecords maxRecords="10" outputFormat="application/xml"
  ...
  it 'correctly renders HITS in response to a Platform constraint POST request with hits resultTye' do
    VCR.use_cassette 'requests/get_records/gmi/platform_hits', :decode_compressed_response => true, :record => :once do
      # notice the outputSchema below http://www.isotc211.org/2005/gmi, which is not the GCMD one http://www.isotc211.org/2005/gmd
      # TODO - revisit this once CMR supports ISO 19115 gmd
      combined_only_constraint_get_records_request_xml = <<-eos
<csw:GetRecords maxRecords="10" outputFormat="application/xml"
  ...
  it 'correctly renders HITS in response to a Platform constraint POST request with NO resultTye' do
    VCR.use_cassette 'requests/get_records/gmi/platform_hits', :decode_compressed_response => true, :record => :once do
      # notice the outputSchema below http://www.isotc211.org/2005/gmi, which is not the GCMD one http://www.isotc211.org/2005/gmd
      # TODO - revisit this once CMR supports ISO 19115 gmd
      combined_only_constraint_get_records_request_xml = <<-eos
