...
RSpec.describe "various GetRecords POST requests containing the AnyText ISO queryable", :type => :request do
  ...
  it 'correctly reders FULL RESULTS ISO MENDS (GMI) data in response to a keyword ONLY constraint POST request' do
...
<csw:GetRecords maxRecords="10" outputFormat="application/xml"
  ...
  it 'correctly reders FULL CSW RESULTS data in response to a keyword ONLY constraint POST request' do
